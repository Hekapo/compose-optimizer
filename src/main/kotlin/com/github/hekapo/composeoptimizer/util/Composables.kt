...
import com.github.hekapo.composeoptimizer.compose.ComposeAnnotation
import com.intellij.psi.PsiElement
import org.jetbrains.kotlin.psi.*
import org.jetbrains.kotlin.psi.psiUtil.referenceExpression

val KtNamedFunction.emitsContent: Boolean
    get() {
        return if (hasAnnotation(ComposeAnnotation.Composable)) {
            sequence {
